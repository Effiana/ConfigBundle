...
class SettingsController extends AbstractController {
	...
	public function modifyAction(Request $request) {
		...
		$repo = $em->getRepository($this->container->getParameter('effiana_config.entity_name'));
		$allStoredSettings = $repo->findAll();
		$cache = $this->get('effiana_config_cache_adapter');
		...
		return $this->render('@EffianaConfig/Settings/modify.html.twig', [
